      ...
      <section className="py-16 md:py-24 px-6 sm:px-10 md:px-16 lg:px-20 max-w-[1600px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          >
            ...
            {/* Satellite Map Embed */}
            <div className="relative w-full h-[280px] sm:h-[340px] rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-gray-100">
              <iframe
                title="Profound Vanam Satellite Map Location"
                src="https://maps.google.com/maps?q=Pragathi+Nagar,+Near+Exit+Kaman,+Bachupally,+Telangana&t=k&z=16&ie=UTF8&iwloc=&output=embed"
