...
export default function Hero() {
  return (
    <div className="w-full bg-brand-green overflow-hidden relative">
      <section className="w-full max-w-[1920px] mx-auto text-white flex flex-col lg:flex-row items-center justify-between min-h-[calc(100vh-80px)] pt-8 md:pt-12 lg:pt-0">
        ...
        <motion.div 
          ...
          className="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 md:px-16 lg:pl-20 lg:pr-8 py-8 md:py-12 lg:py-0 z-10 text-left"
        >
        ...
        >
          <img 
            ...
            className="w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-none h-auto max-h-[70vh] lg:max-h-[85vh] object-contain object-bottom block" 
          />
        </motion.div>
